...
- Search results for posts, people, and places.
- Discover state in Search with trending chips and popular places.
- Places tab with saved locations and map view.
- Restaurant detail pages with Rekkus ratings, posts, and dish signals.

## Signals

- Post volume by restaurant and cuisine.
- Saves and saved-location activity.
- Search queries, place clicks, and place views.
- Dish tags and best-dish mentions.
- Distance and city/suburb context.
