...
const appEnv: string = process.env.EXPO_PUBLIC_APP_ENV ?? 'development'
const dataMode: string = process.env.EXPO_PUBLIC_DATA_MODE ?? 'mixed'
const sentryEnabled: string = process.env.EXPO_PUBLIC_SENTRY_ENABLED ?? ''
...
export const GIPHY_IOS_API_KEY: string = process.env.EXPO_PUBLIC_GIPHY_IOS_API_KEY ?? ''
export const GIPHY_ANDROID_API_KEY: string = process.env.EXPO_PUBLIC_GIPHY_ANDROID_API_KEY ?? ''
export const EXPO_PROJECT_ID: string = process.env.EXPO_PUBLIC_EXPO_PROJECT_ID ?? ''
