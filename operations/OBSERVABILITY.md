...
| App failures | Crash/error reporting | [../BACKLOG.md](../BACKLOG.md) |
...
| --- | --- | --- | --- | --- |
| B-156 | Crash/error reporting | `components/ErrorBoundary.tsx`, release smoke notes, future crash provider | Every release and after user-reported crashes | Record issue, rollback if release-blocking, choose provider before public scale. |
