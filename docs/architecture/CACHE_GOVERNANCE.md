...
- Selected Google restaurant results must flow into `restaurants`, `restaurant_sources`, `restaurant_provider_cache`, and `restaurant_audit_events`; raw autocomplete prediction payloads must not become a permanent search cache.
